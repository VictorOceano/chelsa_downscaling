...
for HOUR in {0..24}
do
singularity exec -B /storage /home/karger/singularity/chelsa_highres_V.1.0.sif python /home/karger/Documents/bio/Bio_Backup/python_git/chelsa_highres/chelsa_highres.py --year $YEAR --month $MONTH --day $DAY --hour $HOUR --temp $TEMP --era5 $ERA5 --input $INPUT --output $OUTPUT
done
